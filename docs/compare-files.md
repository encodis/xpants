...
Compare two directories and report on the differences (shallow, names only)
...
Compare two directories and report on the differences (deep, compare individual files)

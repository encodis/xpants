			...
			<xsl:otherwise>
              ...
              | $theDocument_1//*[@id= $fragment-id ]" />
							<xsl:if test="not($theFragment_1)">
								<xsl:message terminate="no">
									<xsl:text>Unable to locate id attribute1: </xsl:text>
									<xsl:value-of select="@href" />
								</xsl:message>
							</xsl:if>
							<xsl:apply-templates
					...
					<xsl:otherwise>
						...
						<xsl:if test="not($theFragment_2)">
							<xsl:message terminate="no">
								<xsl:text>Unable to locate id attribute2: </xsl:text>
								<xsl:value-of select="@href" />
							</xsl:message>
						</xsl:if>
              			...
              			$theDocument_1//iso:*[@id= $fragment-id ]" />
							...
							<xsl:choose>
								...
								<xsl:when test="not($theFragment_1)">
									<xsl:message terminate="no">
										<xsl:text>Unable to locate id attribute3: </xsl:text>
										<xsl:value-of select="@href" />
									</xsl:message>
								</xsl:when>
					...
					<xsl:otherwise>
						...
						<xsl:choose>
							...
							<xsl:when
								...
								<xsl:message terminate="no">
									<xsl:text>Unable to locate id attribute4: </xsl:text>
									<xsl:value-of select="@href" />
								</xsl:message>
							</xsl:when>
						...
						<xsl:for-each select="$theDocument_1">
              			...
              			$theDocument_1//iso:*[@id= $fragment-id ]" />
							...
							<xsl:choose>
								...
								<xsl:when test="not($theFragment_1)">
									<xsl:message terminate="no">
										<xsl:text>Unable to locate id attribute5: </xsl:text>
										<xsl:value-of select="@href" />
									</xsl:message>
								</xsl:when>
					...
					<xsl:otherwise>
						...
						<xsl:choose>
							...
							<xsl:when
								test="not($theFragment_2) and not ($theContainedFragments)">
								<xsl:message terminate="no">
									<xsl:text>Unable to locate id attribute6: </xsl:text>
									<xsl:value-of select="@href" />
								</xsl:message>
							</xsl:when>
			...
			<xsl:otherwise>
				<xsl:choose>
              	...
              	$theDocument_1//schold:*[@id= $fragment-id ]" />
							...
							<xsl:if test="not($theFragment_1)">
								<xsl:message terminate="no">
									<xsl:text>Unable to locate id attribute7: </xsl:text>
									<xsl:value-of select="@href" />
								</xsl:message>
							</xsl:if>
							<xsl:apply-templates
					...
					<xsl:otherwise>
						...
						<xsl:if
							test="not($theFragment_2) and not ($theContainedFragments)">
							<xsl:message terminate="no">
								<xsl:text>Unable to locate id attribute8: </xsl:text>
								<xsl:value-of select="@href" />
							</xsl:message>
						</xsl:if>
						<!-- If this were XLST 2, we could use  
		...
		<xsl:choose>
			...
			<xsl:otherwise>
               ...
               | $theDocument_1//*[@id= $fragment-id ]" />
							<xsl:if test="not($theFragment_1)">
								<xsl:message terminate="no">
									<xsl:text>Unable to locate id attribute9: </xsl:text>
									<xsl:value-of select="@href" />
								</xsl:message>
							</xsl:if>
							<xsl:apply-templates
					...
					<xsl:otherwise>
						...
						<xsl:if test="not($theFragment_2)">
							<xsl:message terminate="no">
								<xsl:text>Unable to locate id attribute10: </xsl:text>
								<xsl:value-of select="@href" />
							</xsl:message>
						</xsl:if>
						<xsl:apply-templates select="$theFragment_2 "
		...
		<xsl:choose>
			...
			<xsl:otherwise>
               ...
               | $theDocument_1//*[@id= $fragment-id ]" />
							...
							<xsl:if test="not($theFragment_1)">
								<xsl:message terminate="no">
									<xsl:text>Unable to locate id attribute11: </xsl:text>
									<xsl:value-of select="@href" />
								</xsl:message>
							</xsl:if>
					...
					<xsl:otherwise>
						...
						<xsl:if test="not($theFragment_2)">
							<xsl:message terminate="no">
								<xsl:text>Unable to locate id attribute12: </xsl:text>
								<xsl:value-of select="@href" />
							</xsl:message>
						</xsl:if>
		...
		<xsl:choose>
			...
			<xsl:otherwise>
               ...
               | $theDocument_1//*[@id= $fragment-id ]" />
							<xsl:if test="not($theFragment_1)">
								<xsl:message terminate="no">
									<xsl:text>Unable to locate id attribute13: </xsl:text>
									<xsl:value-of select="@xlink:href" />
								</xsl:message>
							</xsl:if>
							<xsl:apply-templates
					...
					<xsl:otherwise>
						...
						<xsl:if test="not($theFragment_2)">
							<xsl:message terminate="no">
								<xsl:text>Unable to locate id attribute14: </xsl:text>
								<xsl:value-of select="@xlink:href" />
							</xsl:message>
						</xsl:if>
						<xsl:apply-templates select="$theFragment_2 "

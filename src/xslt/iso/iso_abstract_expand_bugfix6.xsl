...
<!-- 
     OVERVIEW - iso_abstract_expand_bugfix6.xsl
	    ...
	    schemas, such as when they are embedded in the same NVDL script 
	    	* experimentally, allows parameter recognition and substitution inside
	    	text as well as @context, @test, @select & @value.
...
<!-- 
  VERSION INFORMATION
  2018-02-19 
  		* Fixing bug #6 (https://code.google.com/p/schematron/issues/detail?id=6) with solution proposed by:   
  		  http://itfundamentalist.blogspot.com/2009/03/schematron-stilesheets-wont-work-with.html
...
<xslt:stylesheet version="1.0" xmlns:xslt="http://www.w3.org/1999/XSL/Transform" 
	...
	<!-- Generate a non-abstract pattern (with bugfix 6 applied) -->
	<xslt:template mode="iae:do-pattern" match="*">
		<xslt:param name="caller"/>
		<xslt:copy>
		    <xslt:for-each select="@*[name()='value' or name()='test' or name()='context' or name()='select']">
		    ...
		    <xslt:copy-of select="@*[name()!='value'][name()!='test'][name()!='context'][name()!='select']" />
